...
最近的在思考不少东西，有投资的，也有生活的。让我意识到，许多认知与底层逻辑是可以跨领域迁移的：
其一，投资中的“分散风险”同样适用于生活——人生的重心不应过度单一，需要建立多元的锚点。
其二，宏观周期的普适性。基于康波周期与美林时钟在A股买入矿业股的逻辑（如紫金矿业、天齐锂业），平移至美股同类公司，依然能获得可观的收益印证。
etc.
